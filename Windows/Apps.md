...
- **PowerToys** — Windows utilities suite
- **AltSnap** — Drag windows from anywhere with Alt
- **Revo Uninstaller** — Clean app uninstalls
- **[Windhawk](/Windows/Windhawk/)** — Windows customization mods
- **[Rainmeter](/Windows/Rainmeter.md)** — Desktop widgets & customization
